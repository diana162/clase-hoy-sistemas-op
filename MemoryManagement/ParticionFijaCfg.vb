...
#Region " Windows Form Events "
    ...
    Private Sub ParticionFijaCfg_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        ListaParticiones.Add(New Particion(2, 50, 30, EstadoParticion.Libre)) ' P2 ~ 20kb
        ListaParticiones.Add(New Particion(3, 80, 150, EstadoParticion.Libre)) ' P3 ~ 10kb
        ListaParticiones.Add(New Particion(4, 230, 40, EstadoParticion.Libre)) ' P4 ~ 15kb
        ListaParticiones.Add(New Particion(5, 270, 80, EstadoParticion.Libre))
        ListaParticiones.Add(New Particion(6, 350, 110, EstadoParticion.Libre))
        ListaParticiones.Add(New Particion(7, 460, 20, EstadoParticion.Libre))
        ListaParticiones.Add(New Particion(8, 480, 90, EstadoParticion.Libre))
        ListaParticiones.Add(New Particion(9, 570, 130, EstadoParticion.Libre))
