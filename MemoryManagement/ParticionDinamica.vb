...
#Region " Windows Form Events "
    ...
    Private Sub ParticionFija_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        ListaProcesos.Add(New Proceso("J1", 57, EstadoProceso.Espera, 5)) ' J1 ~ 57kb
        ListaProcesos.Add(New Proceso("J2", 41, EstadoProceso.Espera, 4)) ' J2 ~ 41kb
        ListaProcesos.Add(New Proceso("J3", 89, EstadoProceso.Espera, 8)) ' J3 - 89kb 
        ListaProcesos.Add(New Proceso("J4", 12, EstadoProceso.Espera, 2)) ' J4 ~ 57kb
        ListaProcesos.Add(New Proceso("J5", 18, EstadoProceso.Espera, 6)) ' J5 ~ 41kb
        ListaProcesos.Add(New Proceso("J6", 15, EstadoProceso.Espera, 3)) ' J6 - 89kb 
        ListaProcesos.Add(New Proceso("J7", 90, EstadoProceso.Espera, 6)) ' J7 ~ 57kb
        ListaProcesos.Add(New Proceso("J8", 64, EstadoProceso.Espera, 3)) ' J8 ~ 41kb
        ListaProcesos.Add(New Proceso("J9", 115, EstadoProceso.Espera, 7)) ' J9 - 89kb 
        ListaProcesos.Add(New Proceso("J1", 136, EstadoProceso.Espera, 9)) ' J10 ~ 57kb
        ListaProcesos.Add(New Proceso("J2", 30, EstadoProceso.Espera, 8)) ' J11 ~ 41kb
        ListaProcesos.Add(New Proceso("J3", 57, EstadoProceso.Espera, 6)) ' J12 - 89kb 
        ListaProcesos.Add(New Proceso("J1", 41, EstadoProceso.Espera, 3)) ' J13 ~ 57kb
        ListaProcesos.Add(New Proceso("J2", 16, EstadoProceso.Espera, 2)) ' J14 ~ 41kb
        ListaProcesos.Add(New Proceso("J3", 22, EstadoProceso.Espera, 7)) ' J15 - 89kb 
